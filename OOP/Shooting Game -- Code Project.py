...
# Each hit decreases the lives of the enemies by 1. The given code declares a generic Enemy class, 
# as well as the Alien and Monster classes, with their corresponding lives count. 
...
2. Complete the while loop that continuously takes the weapon of choice from user input and call the
corresponding object's hit() method."""
...
class Enemy:
    ...
    def hit(self):
        # this reduces the lives count by one
        self.lives -= 1
        if self.lives <= 0:
